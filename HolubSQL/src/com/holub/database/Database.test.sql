...
insert into address
values (0, '12 MyStreet', 'Berkeley', 'CA', '99999')
insert into address
values (1, '34 Quarry Ln.', 'Bedrock', 'XX', '00000')

insert into name
VALUES ('Fred', 'Flintstone', '1')
insert into name
VALUES ('Wilma', 'Flintstone', '1')
insert into name (last, first, addrId)
VALUES ('Holub', 'Allen', (10 - 10 * 1))
...
insert into id
VALUES (0, 'AddressID=0')
insert into id
VALUES (1, 'AddressID=1')
...
insert into foo (first, third, fourth)
values (1, 3, 4)
update foo
set fourth=null
where fourth = 4
